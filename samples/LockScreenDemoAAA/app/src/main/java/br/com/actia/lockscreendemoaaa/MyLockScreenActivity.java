...
public class MyLockScreenActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Start service
        Intent i = new Intent(MyLockScreenActivity.this, MyService.class);
        startService(i);
    }
