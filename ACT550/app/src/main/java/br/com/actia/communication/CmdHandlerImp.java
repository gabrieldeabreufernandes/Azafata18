...
public class CmdHandlerImp {
    ...
    public CmdHandlerImp(Context context) {
        ...
        listCmdHandlers.add(new CmdHandler_EquipmentStatus(context));
        listCmdHandlers.add(new CmdHandler_MediaPlayerStatus(context));
        ...
        listCmdHandlers.add(new CmdHandler_InactiveMediaPlayerStatus(context));
    }
