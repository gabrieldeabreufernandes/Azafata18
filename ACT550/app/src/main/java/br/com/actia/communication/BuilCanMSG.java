...
public class BuilCanMSG {
    ...
    public BuilCanMSG setType(byte type) {
    ...
    public BuilCanMSG setId(String strId) {
        canMsg.setId((int) hexTextToInt(strId));
        return this;
    }

    public BuilCanMSG setLength(int length) {
        canMsg.setLength((byte) length);
        return this;
    }

    public BuilCanMSG setData(String data) {
