...
public class PlaylistHandler {
    ...
    private static final String FOLDER_PATH_ASUS    = "/mnt/sdcard/Download/";
    private static final String FOLDER_PATH_GENESIS = "/sdcard/external_sdcard/act5xx/playlist/";

    private static final String FOLDER = "/playlists/";
    private static final String FOLDER_FILTER = ".json";
     ...
     * @return
     */
    public List getPlaylists(int type) {
        String path = "";
        switch (type){
            case PLAYLIST_SD:
                break;
        ...
        String files[] = directory.list(new FilenameFilter() {
            ...
            public boolean accept(File file, String name) {
                return name.contains(FOLDER_FILTER);
            }
        });
    ...
    private String getExternalsdPath() {
        ...
        File file = new File(FOLDER_PATH_ACTIA);
        if(file != null && file.exists() && file.isDirectory()) {
            return FOLDER_PATH_ACTIA;
        }

        file = new File(FOLDER_PATH_GENESIS);
        if(file != null && file.exists() && file.isDirectory()) {
            return FOLDER_PATH_GENESIS;
        }

        file = new File(FOLDER_PATH_ASUS);
        if(file != null && file.exists() && file.isDirectory()) {
